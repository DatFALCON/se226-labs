...
x = input("Enter a string to search keyword in array:")
...
if counter !=0:
    print("The keyword you have been searching  is finded which is "+x)
else:
    print("The keyword you are looking for isn't founded.")
